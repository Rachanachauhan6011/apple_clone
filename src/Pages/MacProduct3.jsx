...
const product = [
    ...
    {
        id:2,
        info:"Shop with a Specialist",
        heading:"Whether you shop in a store or online, our Specialists can help you pick something perfect.",
      ...
      {
        id: 3,
        info:"Join an online Personal S⁠e⁠t⁠u⁠p⁠ ⁠s⁠e⁠s⁠s⁠i⁠o⁠n⁠.",
        heading:"Talk one-to-one with a Specialist to set up your Mac and discover new features.",
...
const ProductCard = ({product})=>{
    ...
    <img src={product.image} alt={product.info} className='p-5'/>
      <h2 className='text-[30px] pl-4 pt-5 font-semibold' >{product.info}</h2>
            <p className='text-[15px]  text-gray-800 pl-4'>{product.heading}</p>
    </div>
...
const MacProduct3 = () => {
  return (
     <div className='h-auto flex flex-col mt-5'>
        <h1 className=' text-7xl py-10 pl-10 font-semibold w-200'>Why Apple is the best place to buy Mac.</h1>
